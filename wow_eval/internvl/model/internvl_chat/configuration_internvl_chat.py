...
class InternVLChatConfig(PretrainedConfig):
    ...
    def __init__(
        ...
        ###### 强行赋值为 ['Qwen2ForCausalLM']
        if not llm_config or 'architectures' not in llm_config or not llm_config['architectures'] or not llm_config['architectures'][0]:
            print("[警告] llm_config['architectures'] 为空，强行赋值为 ['Qwen2ForCausalLM']")
